...
banner() {
    ...
    if ! [ -x "$(command -v toilet)" ]; then
        echo -e "\e[4;34m This Bomber Was Created By \e[1;32mSanjay \e[0m"
    else
        echo -e "\e[1;34mCreated By \e[1;34m"
        toilet -f mono12 -F border Sanjay
    fi
    echo -e "\e[1;34m For Any Queries Join Me!!!\e[0m"
    echo -e "\e[1;32m           Whatsapp : +91 8807431314 \e[0m"
    echo -e "\e[4;32m   Instagram: https://www.instagram.com/im._.sanjayharish?igsh=ZHNvdjRpeGs5YmZ3 \e[0m"
    echo " "
...
if [ -f .update ];then
    ...
    echo .
    install_deps
    echo This Script Was Made By Sanjay > .update
